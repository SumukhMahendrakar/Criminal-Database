...
if(isset($_POST['s'])){
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        $pol_id = "SELECT * FROM police WHERE location = '$location'";
        $pidres = mysqli_query($conn, $pol_id);
        $pidrow = mysqli_fetch_assoc($pidres);
    ...
    if($var>=0)
    {
      ...
      $comp="INSERT into complaint(`a_no`, `location`, `type_crime`, `d_o_c`, `description`, `p_id`, `pol_status`) VALUES('$a_no','$location','$type_crime','$d_o_c','$description', '$pid', 'In Process')";
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<div class="top-w3-agile" style="color: gray">Location of Crime
                    ...
                    <select class="form-control" name="location">
						<?php
                        $loc=mysqli_query($conn,"select location from police");
